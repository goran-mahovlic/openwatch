...
// changed name for ID107HR_Plus
#define DEVICE_NAME                          "DEVKITDFU"                                               /**< Name of device. Will be included in the advertising data. */
